...
def main() -> int:
    ...
    paths = save_outputs(classifications, eligibility, output_dir=args.output_dir)
...
def save_outputs(classifications, eligibility, *, output_dir: Path = DEFAULT_ANALYSIS_DIR) -> dict[str, Path]:
